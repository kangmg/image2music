...
![Untitled](/content/stremlit/보고서_res/Untitled.png)
...
- 성능
    - 평가 그래프
        ...
        ![Accs_and_F1.png](/content/stremlit/보고서_res/Accs_and_F1.png)
...
- 음원에서 5가지 무드(aggressive, dramatic, happy, romantic, sad)를 분류하는 다중분류 모델
    ...
    ![Untitled](/content/stremlit/보고서_res/Untitled1.png)
...
- Multi-Agent 구조
    ...
    ![Untitled](/content/stremlit/보고서_res/Untitled4.png)
...
- `Home`
    ...
    ![Untitled](/content/stremlit/보고서_res/Untitled5.png)
    
- `PlayList 추천 페이지`
    
    ![Untitled](/content/stremlit/보고서_res/Untitled6.png)
    
- `실제 음악 추천 화면`
    
    ![Untitled](/content/stremlit/보고서_res/Untitled7.png)
